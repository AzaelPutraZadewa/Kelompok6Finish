                  ...
                  <table class="table table-bordered">
                    ...
                    $sql_k .=" ORDER BY `judul` limit $posisi, $batas";
                      ...
                      <tr>
                        ...
                        <td align="center">
  								  <a href="index.php?include=edit-buku&data=<?php echo $data_k['id_buku'];?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
										<a href="index.php?include=detail-buku&data=<?php echo $data_k['id_buku'];?>" class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
