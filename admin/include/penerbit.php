                    ...
                    <tr>
                      ...
                      <td><?php echo $alamat;?></td>
								  ...
								  <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $penerbit; ?>?'))
								 	 	window.location.href = 'index.php?include=penerbit&aksi=hapus&data=
								 		<?php echo $id_penerbit;?>&notif=hapusberhasil'" class="btn btn-xs btn-warning">
              ...
              <?php
							$sql_jum = "select `id_penerbit`, `penerbit`, `alamat` from `penerbit` ";
										if (!empty($katakunci_kategori)){
											$sql_jum .= " where penerbit LIKE '%$katakunci_kategori%' OR alamat LIKE '%$katakunci_kategori%'";
										}
