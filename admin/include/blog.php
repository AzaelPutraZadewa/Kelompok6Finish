            ...
            <div class="card">
              ...
              <table class="table table-bordered">
                    ...
                    if (!empty($katakunci_blog)){
                         $sql_k .= " where judul LIKE '%$katakunci_blog%' OR kategori_blog LIKE '%$katakunci_blog%' ";
                    }
                    $sql_k .=" ORDER BY `judul` limit $posisi, $batas";
                      ...
                      <tr>
                        <td><?php echo $no;?></td>
                        <td><?php echo $data_k['kategori_blog'];?></td>
                        <td><?php echo $data_k['judul'];?></td>
                        <td><?php echo $data_k['tanggal'];?></td>
                        <td align="center">
                    <a href="index.php?include=edit-blog&data=<?php echo $data_k['id_blog'];?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
                    <a href="index.php?include=detail-blog&data=<?php echo $data_k['id_blog'];?>" class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                    <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $data_k['judul'];?>?'))
                      window.location.href = 'index.php?include=blog&aksi=hapus&data=
                      <?php echo $data_k['id_blog'];?>&notif=hapusberhasil'" class="btn btn-xs btn-warning">
                  ...
                  $sql_jum = "SELECT * FROM blog
                            ...
                            INNER JOIN user ON blog.id_user = user.id_user";
                        if (!empty($katakunci_blog)){
                          $sql_jum .= " where judul LIKE '%$katakunci_blog%' OR kategori_blog LIKE '%$katakunci_blog%'";
                        }
